...
$resources[10]->setContent(file_get_contents($sources['data'].'resources/fully_configured.content.html'));
...
$resources[11]->setContent(file_get_contents($sources['data'].'resources/easy_to_use_and_update.content.html'));
