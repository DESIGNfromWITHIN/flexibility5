 ...
 * @language de
 */
$_lang['sisea.activefacet_desc'] = 'Die momentan aktive Facette. Nehmen Sie hier keine Änderung vor, wenn Sie nicht ein Suchergebnis aus einer nicht standardmäßigen, durch einen postHook generierten Facette anzeigen möchten.';
...
$_lang['sisea.facetlimit_desc'] = 'Die Anzahl der Suchergebnisse aus nicht aktiven Facetten, die auf der Haupt-Suchergebnisseite angezeigt werden sollen. Der Standardwert ist 5.';  // main results page?
$_lang['sisea.fieldpotency_desc'] = 'Geben Sie die Gewichtung für die Reihenfolge der Suchergebnisse an. Beispiel: pagetitle:3,alias:10 vergibt 3 Punkte, wenn der gesuchte Begriff im Feld "pagetitle" gefunden wird, und 10 Punkte, wenn er im Feld "alias" gefunden wird.';
$_lang['sisea.get'] = 'get';
...
$_lang['sisea.pagelimit_desc'] = 'Die maximale Anzahl an Seiten-Links, die angezeigt werden, wenn Seitennavigations-Links dargestellt werden.';
$_lang['sisea.pagetpl_desc'] = 'Gibt den Chunk an, der für die Seitennavigations-Links verwendet wird.';
$_lang['sisea.pagefirsttpl_desc'] = 'Der Chunk, der für den Seitennavigations-Link zur ersten Ergebnisseite verwendet wird.';
$_lang['sisea.pagelasttpl_desc'] = 'Der Chunk, der für den Seitennavigations-Link zur letzten Ergebnisseite verwendet wird.';
$_lang['sisea.pageprevtpl_desc'] = 'Der Chunk, der für den Seitennavigations-Link zur vorhergehenden Ergebnisseite verwendet wird.';
$_lang['sisea.pagenexttpl_desc'] = 'Der Chunk, der für den Seitennavigations-Link zur nachfolgenden Ergebnisseite verwendet wird.';
...
$_lang['sisea.posthooks_desc'] = 'Alle Hooks, die nach der eigentlichen Suche aufgerufen werden sollen und Facetten-Ergebnisse zu den Suchergebnissen hinzufügen können.';
...
$_lang['sisea.sortby_desc'] = 'Eine kommaseparierte Liste von Ressourcen-Feldern, nach denen die Ergebnisse sortiert werden. Lassen Sie dieses Feld leer, um nach Relevanz und Bewertung zu sortieren.';
$_lang['sisea.sortdir_desc'] = 'Eine kommaseparierte Liste von Ergebnis-Sortierrichtungen. Muss der Anzahl der Einträge im sortBy-Parameter entsprechen.';
...
$_lang['sisea.urlscheme_desc'] = 'Das von Ihnen gewünschte URL-Schema: http, https, full, abs, relative, etc. Siehe die Dokumentation zu $modx->makeUrl(). Diese Einstellung wird verwendet, wenn die Seitennavigations-Links generiert werden.';
$_lang['sisea.url_relative'] = 'Relativ';
$_lang['sisea.url_absolute'] = 'Absolut';
$_lang['sisea.url_full'] = 'Vollständig (full)';
$_lang['sisea.ascending'] = 'Aufsteigend';
$_lang['sisea.descending'] = 'Absteigend';