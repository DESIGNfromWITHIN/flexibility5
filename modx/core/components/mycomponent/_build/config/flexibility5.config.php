...
$packageNameLower = 'flexibility5'; /* No spaces, no dashes */

$components = array(
    /* These are used to define the package and set values for placeholders */
    'packageName' => 'flexibility5',  /* No spaces, no dashes */
    'packageNameLower' => $packageNameLower,
    'packageDescription' => 'Responsive MODX Revolution template based on Foundation 5 from ZURB.',
    'version' => '2.1.0',
    'release' => 'pl',
    'author' => 'Menno Pietersen',
    'email' => 'info@mpthemes.com',
    'authorUrl' => 'http://mpthemes.com',
    'authorSiteName' => "MPthemes",
    'packageDocumentationUrl' => 'https://github.com/DESIGNfromWITHIN/flexibility5/blob/master/README.md',
    'copyright' => '2015',
    ...
    */
    ...
    'namespaces' => array(
        'flexibility5' => array(
            'name' => 'flexibility5',
            'path' => '{core_path}components/flexibility5/',
            'assets_path' => '{assets_path}components/flexibility5/',
        ),
    ),
    ...
    */
    ...
    'categories' => array(
        ...
        'Contact' => array(
            'category' => 'Contact',
            'parent' => 'Flexibility 5', /* nested under flexibility5 */
        ),
        'Navigation' => array(
            'category' => 'Navigation',
            'parent' => 'Flexibility 5', /* nested under flexibility5 */
